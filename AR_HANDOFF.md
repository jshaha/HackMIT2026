...
(the default: charcoal cards, white text, neon teal) or **light frost**. The patient is framed by a single clean
circle, with a line running from it out to each metric.
